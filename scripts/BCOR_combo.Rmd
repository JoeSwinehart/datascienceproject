...
ggplot() +
  geom_smooth(data = combined, aes(x = year, y = frequency), color = "cornflowerblue") +
  geom_smooth(data = BCAutism, aes(x = SCHOOL_YEAR, y = NUMBER_OF_STUDENTS), color = "red") +
  labs(title = "Visualizing BC and Oregon Headcount of Autism Spectrum Disorder",
        x = "School Year",
        y = "Headcount")
