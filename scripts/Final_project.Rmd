...
ggplot(rural_districts, 
  ...
  labs(title = "Total Students by Exceptionality - Rural",
       x = "Exceptionality",
...
Taken side by side, a simple visualization detailing student exceptionality designation presents the overall similarities between urban and rural areas, as in figures x and x below. Of note, the “Gifted” designation suffers a severe drop around 2005/2006 for urban and rural areas alike, though the change is more pronounced within rural districts.
